...
- React widgets must live in the designated React module — do not add React code to other modules
...
- GraphQL operations use Apollo Client directly — no codegen. New providers must be wired into the project's provider singleton.
...
| --------------------------- | --------------------------------------------------------- |
| Multi-step React form       | Existing form components in `components/`                 |
| React widget entry point    | Existing widget files in `widgets/`                       |
